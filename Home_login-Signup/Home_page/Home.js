...
function Home() {
    ...
    return (
        <>
            <div>
                <section className={HomeStyle.first_section}>
                    <header>
                        <h1>Airport Stage</h1>
                        <ul>
                    ...
                    <div className={HomeStyle.mobile}>
                        <div className={HomeStyle.mobile_nav} onClick={mobilenav}>
                            <div style={{ transition: "1s" }}></div>
                            <div></div>
                            <div style={{ transition: "1s" }}></div>
                        </div>
                        <div className={HomeStyle.ul_div}>
                            <ul>
                                <li><Link to='/Signup'>Sign Up</Link></li>
                                <li><Link className={HomeStyle.Login} to='/Login'>Login</Link></li>
                            </ul>
                        </div>
                    </div>
                    <div className={HomeStyle.Content_section}>
                        ...
                        <div className={HomeStyle.svg3}>
                        </div>
                    </div>
                    <div className={HomeStyle.dark_mode}>
                        <p style={{ background: `url(${img})`, width: "30px", height: "30px" }}></p>
                        <p>light-mode</p>
                    </div>
                </section>
                <section className={HomeStyle.section_two}>
                    <div className={HomeStyle.Content_section2}>
                        <div className={HomeStyle.svg_class}>
                ...
                <section id={HomeStyle.explain} className={HomeStyle.section_three}>
                    <div className={HomeStyle.Content_section3}>
                        <div>
                            <p>We are happy to have you here and excited to help you take off on your career journey.
                                Our mission is to provide you with the best airport internship opportunities,
                                where you can gain valuable experience and grow your skills. Take a look around and explore our resources,
                        ...
                        <div className={HomeStyle.div_world}>
                            <div  className={HomeStyle.Aero}></div>
                            <img src={img2} alt="" className={HomeStyle.svg_class2}/>
                        </div>
                    </div>
