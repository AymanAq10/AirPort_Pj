...
export default function App() {
  const Loginauth = useSelector((state)=>state.LoginReducer.Login);
  ...
  return (
    <Router>
      <Routes>
        ...
        {/* {Loginauth && <Route path='/Account' element={<UserPage Element={<Provider store={store}><Home Profile={<Account />} /> </Provider>} />} />} */}
